    ...
    <section className="p-6">
      ...
      <div className="w-full grid lg:grid-cols-4 sm:grid-cols-1 smd:grid-cols-1 lg:max-w-7xl md:gap-2 lg:gap-8 mx-auto sm:max-w-screen-sm smd:max-w-screen-smd md:max-w-screen-md mb-6 bg-white">
        {[
          ...
          { icon: RiBankLine, label: "Payments", bgColor: "", textColor: "" },
          {
          ...
          { icon: LuNetwork, label: "Workflows", bgColor: "", textColor: "" },
        ].map((button, index) => (
          <button
            key={index}
            className={`flex flex-row justify-center items-center gap-2 py-3 rounded-lg hover:bg-blue-500/10 hover:text-blue-400 ${button.bgColor} ${button.textColor}`}
          >
      ...
      <div className="flex flex-col lg:flex-row gap-8  max-w-7xl mx-auto">
        <div className="bg-blue-50 rounded-3xl p-6 flex flex-col md:flex-row gap-6 flex-1">
          {/* Users Card */}
