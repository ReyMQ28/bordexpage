    ...
    <div className=" bg-gray-50">
      ...
      <div>
        <div className="w-full grid grid-cols-4 max-w-[1200px] gap-4 mx-auto bg-white">
          <button className="flex flex-row justify-center items-center gap-2 bg-sky-500 text-white py-3 rounded hover:bg-sky-100 hover:text-blue-400">
            <HiOutlineUsers className="text-xl" />{" "}
            <p className="font-semibold text-lg">Team Scheduling </p>
          </button>
          <button className="flex flex-row justify-center items-center gap-2 py-3 rounded hover:bg-sky-100 hover:text-blue-400">
