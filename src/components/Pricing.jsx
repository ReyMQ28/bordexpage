...
function Pricing() {
  return (
    <section
      id="pricing"
      className="w-full py-12 md:py-20 lg:py-10 mb-12 bg-gray-50"
    >
      <div className="container px-4 mb-1 md:px-6">
        ...
        <div className="mx-auto grid max-w-6xl mb-8 grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-8">
          {/* Recuadro 1 */}
          <div className="flex flex-col justify-between rounded-2xl bg-white border border-gray-200 p-6 shadow-md hover:border-sky-900 hover:bg-blue-500/10">
            ...
            <button className="mt-8 bg-sky-500 text-white rounded-full w-auto py-2 hover:bg-sky-600">
              Get Started
            </button>
          </div>
          {/* Recuadro 2 */}
          <div className="flex flex-col justify-between rounded-2xl bg-white border border-gray-200 p-6 shadow-md hover:border-sky-900 hover:bg-blue-500/10">
            ...
            <button
              variant="secondary"
              className="mt-8 bg-sky-500 text-white rounded-full w-auto py-2 hover:bg-sky-600"
            >
              Get Started
            </button>
          </div>
          {/* Recuadro 3 */}
          <div className="flex flex-col justify-between rounded-2xl bg-white border border-gray-200 p-6 shadow-xl hover:border-sky-900 hover:bg-blue-500/10">
            <div className="flex- flex-col text-slate-900">
              <div className="space-y-2">
