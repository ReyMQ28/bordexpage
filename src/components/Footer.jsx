        ...
        <footer className="bg-blue-50 p-4 md:px-32 md:py-12 text-sm">
            <div className="flex flex-col md:flex-row justify-between items-center mb-16">
                ...
                <div className="flex space-x-5 mt-4 md:mt-0">
                    <Link href="https://facebook.com" className="text-gray-700"><FaFacebook /></Link>
                    <Link href="https://twitter.com" className="text-gray-700"><FaTwitter /></Link>
                    <Link href="https://instagram.com" className="text-gray-700"><FaInstagram /></Link>
                    <Link href="https://linkedin.com" className="text-gray-700"><FaLinkedin /></Link>
                </div>
            </div>
            <div className="text-center b-12 text-gray-400">
                &copy; 2025 Desarrollado por WONLY. Todos los derechos reservados.
            </div>
        </footer>
    );
};
