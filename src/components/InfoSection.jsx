      ...
      <div className="w-full relative">
        ...
        <div className="flex flex-col items-center justify-center absolute inset-0 mx-44">
          ...
          <div className="flex gap-5 mt-6 w-auto   ">
            <button className="bg-sky-600 hover:bg-sky-700 text-white px-8 py-2 rounded-lg">
              Explorar Funciones
            </button>
            <button className="flex flex-row items-center justify-center text-white py-3 rounded-lg hover:bg-white/10 px-3">
